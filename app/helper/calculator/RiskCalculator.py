...
class RiskCalculator:
    ...
    :ivar _invalidation_close: Instance of `InvalidationClose` for close position invalidation.
    :type _invalidation_close: InvalidationClose
    :ivar _invalidation_steady: Instance of `InvalidationSteady` for steady invalidation on conditions.
    :type _invalidation_steady: InvalidationSteady
    :ivar _be: Instance of `BreakEven` to determine breakeven ranges for current market conditions.
    :type _be: BreakEven
    :ivar _trailing_stop: Instance of `TrailingStop` for calculating dynamic stop-loss adjustments.
    :type _trailing_stop: TrailingStop
    :ivar pd_risk_calculator: Instance of `PDRiskCalculator` to analyze profit distribution and risks.
    :type pd_risk_calculator: PDRiskCalculator
    :ivar profit_stop_analyzer: Instance of `ProfitStopAnalyzer` for analyzing profit stop parameters.
    :type profit_stop_analyzer: ProfitStopAnalyzer
    :ivar position_size_calculator: Instance of `PositionSizeCalculator` to estimate optimal order sizes.
    :type position_size_calculator: PositionSizeCalculator
