...
class FVGSession(Strategy):
    ...
    def __init__(self):
        ...
        timeFrame4 = ExpectedTimeFrame(240,30)
    ...
    def _analyzeData(self, candles: list, timeFrame: int):
            if timeFrame == 240:
                range = self._strategy_facade.LevelMediator.calculate_fibonacci("PD", candles, lookback=20)
                for level in range:
    ...
    def get_entry(self, candles: list, timeFrame: int)->StrategyResult:
        ...
        if candles and pds and timeFrame == 15:
