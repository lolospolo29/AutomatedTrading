...
class TradeRepository:
    ...
    def add_trade(self, trade: Trade):
        self._db.add("OpenTrades",trade.model_dump(exclude={"strategy_id"}))
    ...
    def update_trade(self, trade: Trade):
        dto = self.get_trade_by_id(trade.trade_id)
        self._db.update("OpenTrades",str(dto.id), trade.model_dump(exclude={"strategy_id"}))
    ...
    def add_order(self, order: Order):
        self._db.add("OpenOrders", order.model_dump(exclude={'strategy_id','entry_frame_work', 'confirmations'}))
    ...
    def get_orders_by_trade_id(self,trade_id:str)->list[Order]:
    ...
    def update_order(self, order: Order):
        dto = self.get_order_by_id(order.order_id)
        self._db.update("OpenOrders",dto.id , order.model_dump(exclude={'strategy_id','entry_frame_work', 'confirmations'}))
    ...
    def add_framework_to_db(self, framework:FrameWork):
        self._db.add("FrameWorks", framework.model_dump(exclude={"strategy_id"}))

    def get_frameworks_by_orderLinkId(self, orderLinkId:str)->list[FrameWork]:
    ...
    def update_framework(self, framework:FrameWork):
        dto = self.get_trade_by_id(framework.tradeId)
        self._db.update("FrameWorks",dto.id , framework.model_dump(exclude={"strategy_id"}))
