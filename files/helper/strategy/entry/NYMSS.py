...
class NYMSS(Strategy):
    ...
    def entry(self, candles: list[Candle], timeFrame: int, relation:Relation, asset_class:str) ->StrategyResult:
        ...
        if candles and pds and timeFrame == 5:
            ...
            fvgs_one_hour: list[PDArray] = [fvg for fvg in pds if fvg._name == "FVG" and fvg.timeframe == 60]
            fvgs_five_minute:list[PDArray] = [fvg for fvg in pds if fvg._name == "FVG" and fvg.timeframe == 5]
